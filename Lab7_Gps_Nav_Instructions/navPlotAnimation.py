...
Details:  Program opens two separate cvs files (odometry & gps) & stores the data (time & coordinates) in lists.        Afterwards, the script plots  the odom & gps coordinates sequentially in time as they were recorded.  
